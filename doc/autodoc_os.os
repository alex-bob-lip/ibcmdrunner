...
Процедура ВывестиОписаниеМетода(Блок, ЭтоНачалоТаблицы)
	...
	Стр = Стр + "<tr>
	|<td><a href=""" + ТипОбъекта + "/" + ИмяОбъекта + "/" + Блок.ИмяМетода + ".htm"">" + Блок.ИмяМетода + "</a></td>
...
Процедура ВывестиОписаниеМетода_МД(ОписаниеБлока, ЭтоНачалоТаблицы)
	Стр = "";
	Если ЭтоНачалоТаблицы Тогда
		Стр = "
		| | Метод | Описание
	...
	Стр = Стр + "| [" + ОписаниеБлока.ИмяМетода + "](" + ТипОбъекта + "/" + ИмяОбъекта + "/" + ОписаниеБлока.ИмяМетода + ".md) | " + ОписаниеБлока.Назначение + " ";
...
Процедура ВывестиЗаголовокРаздела_МД(ИмяРаздела)
	Стр = "##" + ПрефиксНумерацииРазделов + " " + ИмяРаздела;
	СодержимоеТаблицыМетодов_МД.ДобавитьСтроку(Стр);
КонецПроцедуры
