...
```bsl
// Установить параметры автономного сервера. Необходимо для версии платформы 8.3.20 и выше
// Параметры:
//  КаталогАС - Строка - каталог с данными автономного сервера
```
...
ВАЖНО!!! см. https://github.com/alex-bob-lip/ibcmdrunner/issues/2
